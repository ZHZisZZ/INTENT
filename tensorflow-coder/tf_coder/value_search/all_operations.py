...
def get_operation_names(
    include_sparse_operations: bool = False) -> List[Text]:
  """Returns a list of Operation objects name that value search should use."""
  operations = get_operations(include_sparse_operations)
